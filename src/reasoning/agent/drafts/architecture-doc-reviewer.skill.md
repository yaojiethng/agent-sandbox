...
**No duplicate content across documents.** The agent-facing documents (`readme.md`, `AGENTS.md`, handover files) each answer a distinct question. Content that appears in more than one of them is a violation.
