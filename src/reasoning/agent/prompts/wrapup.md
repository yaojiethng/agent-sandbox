...
**Seed what's next (Step 9):** Populate the What's Next section per `handover_policy.md`. If the completed sub-milestone was the last in the major milestone, write: "Major loop required before next iteration."
