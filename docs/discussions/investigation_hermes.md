...
See [story_provider_knowledge_store.md — Investigation Questions](story_provider_knowledge_store.md#investigation-questions) for the standard question set. All six questions must be answered before a recommendation can be made.
...
1. Identify Hermes and confirm it is a viable AI coding agent candidate
2. Answer investigation questions against the standard set
