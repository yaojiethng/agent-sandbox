...
Context for Change 2: [`20260412-02-m2_3_onhold.md`](20260412-02-m2_3_onhold.md) (frozen design), [`docs/devlog/discussions/design_git_workflow_improvements.md`](../discussions/design_git_workflow_improvements.md) (current spec — note: Context and Status section of this document is due for a refresh).
