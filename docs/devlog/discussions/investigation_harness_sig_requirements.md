...
- [`docs/devlog/handovers/20260513-13-study-grill_harness_sig_investigation.md`](../../devlog/handovers/20260513-13-study-grill_harness_sig_investigation.md) — current open session
