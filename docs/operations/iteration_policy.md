...
| **Minor** | 1. Open handover | §Step 1 Details |
| | 2. Confirm scope | §Step 2 Details |
...
| | 5. Acceptance criteria | §Step 5 Details |
| | **Gate 2** | wait for operator release before implementation |
| | 6. Implementation | — |
| | 7. Pre-close verification | §Step 7 Details |
| | **Gate 3** | wait for operator release before session close |
| | 8–9. Close and seed | §Steps 8–9 Details |
