...
5. **The comparison surface grows quadratically.** Each policy revision produces N skills to check. Each skill references M policy sections. The audit load is N x M and grows with every policy change and every new skill.
