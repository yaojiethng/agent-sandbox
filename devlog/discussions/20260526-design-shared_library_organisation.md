...
Files are grouped by a two-dimensional grid: **deployment target** (host / capability container / reasoning container) x **lifecycle stage** (build-time / runtime).
...
|---|---|---|
| Image naming | `agent_base_image_name`, `agent_image_name`, `sandbox_image_name` | [x] Pure functions, zero deps |
| Build context prep | `_build_context_copy`, `build_context_sandbox`, `build_context_agent` | [x] Self-contained file ops |
| Build execution | `build_image`, `build_agent`, `build_sandbox` | [!] Call naming + context -- tightly coupled |
| Preflight | `preflight` | [x] Standalone |
...
|---|---|---|
| `diff.sh` | [x] (sandbox.Dockerfile #27) | [y] in build context but NOT COPY'd |
| `package_branch.sh` | [x] (sandbox.Dockerfile #30) | [y] in build context but NOT COPY'd |
| `package_diff.sh` | [y] not in sandbox.Dockerfile | [x] (provider.Dockerfile #12) |
...
|---|---|---|---|---|
| `build/image.sh` | [x] sourced | [ ] | [ ] | Build |
| `build/context.sh` | [x] sourced | [ ] | [ ] | Build |
| `build/compose.sh` | [x] sourced | [ ] | [ ] | Build |
| `libs/host/build.sh` | [x] sourced | [ ] | [ ] | Host runtime |
| `libs/host/guards.sh` | [x] sourced | [ ] | [ ] | Host runtime |
| `libs/host/workflows/*` | [x] sourced | [ ] | [ ] | Host runtime |
| `libs/shared/session_state.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/shared/routing.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/shared/dirs.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/shared/diff.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/shared/diff_export.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/shared/package_branch.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/shared/package_diff.sh` | [x] sourced | [x] deployed | [x] deployed | Runtime |
| `libs/capability/entrypoint.sh` | [ ] | [x] deployed | [ ] | Runtime |
| `libs/capability/snapshot.sh` | [ ] | [x] deployed | [ ] | Runtime |
| `libs/reasoning/entrypoint.sh` | [ ] | [ ] | [x] deployed | Runtime |
