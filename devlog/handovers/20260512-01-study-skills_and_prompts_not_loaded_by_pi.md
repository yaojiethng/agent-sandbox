...
| # | Criterion | Status |
|---|---|---|
| 1 | Root cause identified: copy-out/copy-in cycle stripped custom `skills`/`prompts` keys from settings.json | [x] |
| 2 | settings.json re-seeded in bind-mount and AGENT_HOME with runtime defaults preserved | [x] |
| 3 | Skills/prompts confirmed loading after container restart | [x] |
| 4 | Knowledge test `tests/knowledge/knowledge_provider_config_cycle.sh` exists and passes | [x] |
| 5 | Config flow diagram and fragility notes added to `docs/architecture/provider_lifecycle.md` | [x] |
| 6 | Three-layer skills/prompts model documented in `docs/concepts/agent_workflow.md` | [x] |
