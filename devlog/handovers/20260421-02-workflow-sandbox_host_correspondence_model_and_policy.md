...
|---|---|---|
| `docs/concepts/sandbox_host_correspondence_model.md` | New -- correspondence model concepts doc | [x] Complete |
| `docs/discussions/design_apply_workflow_and_baseline_advancement.md` | Header update + known gaps section | [x] Complete |
| `docs/operations/documentation_policy.md` | Concepts Docs subsection added | [x] Complete |
| `docs/operations/iteration_policy.md` | Step notation + Step 3 row updated | [x] Complete |
