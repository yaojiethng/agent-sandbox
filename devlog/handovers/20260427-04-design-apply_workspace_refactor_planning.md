...
- Spec produced and approved by operator. [x]
- All open questions resolved before spec was closed. [x]
- Atomic changes sequenced bottom-up with explicit preconditions and postconditions. [x]
