...
| AC7 | Suite deterministic | 524/524 x 3 consecutive full runs, RC=0 each (~22s/run) | accepted |
...
Net: 504 inflated passes -> 524 real tests, deterministic x3, zero skips.
