...
- F1: Add Makefile variable validation section to `docs/development/cli-standards.md`
...
| 3 | `cli-standards.md` has a Makefile variable validation section | `grep -n "^## \\|Makefile" docs/development/cli-standards.md` shows new section | Agent |
...
| [`docs/development/cli-standards.md`](../docs/development/cli-standards.md) | Add Makefile variable validation section |
...
|---|---|---|
| F1: Fix echo messages + Makefile guard + cli-standards convention | Makefile variable is `FROM`; `CHANNEL=` is wrong input that must error, not be silently ignored | `Makefile.template`, `cli-standards.md` |
...
| [`docs/development/cli-standards.md`](../docs/development/cli-standards.md) | Added §8 — Makefile variable overrides must be validated |
...
- F1 (FROM/CHANNEL) resolved: echo messages fixed, Makefile guard added, cli-standards.md updated
