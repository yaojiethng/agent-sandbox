...
| # | Criterion | Status |
|---|---|---|
| 1 | Pre-flight block exists in `sandbox-entrypoint.sh` after baseline init, before diff pipeline | [x] |
| 2 | 5 CRITICAL checks (SESSION_STATE keys x2, SNAPSHOT_DIR, CHANGES_DIR, INPUT_DIR, OUTPUT_DIR) | [x] |
| 3 | 2 WARN checks (brief.md, working tree clean) | [x] |
| 4 | CRITICAL failures exit 1 (non-zero) | [x] |
| 5 | `bash -n` passes | [x] |
...
| `docs/devlog/roadmap.md` | Marked 11b as [x] |
