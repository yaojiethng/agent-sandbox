...
|---|---|---|---|
| -04 | ADR recreation + concept sweep | completed roadmap item (`roadmap.md` line 162, marked `[x]` with summary) | [x] |
| -05 | two-container + correspondence ADRs | operator-directed new docs work; no roadmap item existed; no generated task | [x] (invisible on roadmap, but nothing owed) |
| -06/-07/-09 | consolidation, prose, reconcile rule | chores/policy; no generated tasks | [x] |
| -08 | runner selftest | advances the already-`[x]` hardening item; no new task | [x] |
...
| -11 | wrapping policy + sweep + tooling | tooling promoted in-iteration; no open generated task | [x] |
| extra | roadmap_future M3 workflow-separation task | written to roadmap when directed | [x] |
