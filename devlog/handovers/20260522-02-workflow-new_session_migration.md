...
|---|---|---|---|
| I1 -- No "Step 1b" | [ ] | [x] | [x] |
| I2 -- No compaction at Step 1 | [ ] | [ ] | [x]^1 |
| I3 -- Trigger B present | [x] | [x] | [x]2 |
| I4 -- Scope + AC gates | [x] | [x] | [x] |
| I5 -- Policy doc references | [x] | [x] | [x] |
| I6 -- No old Trigger B wording | [x] | [x] | [x] |
| I7 -- No old compaction wording | [x] | [ ] | [x] |
| BONUS -- Divergence detection | [ ] | [x] | [x] |
| **Total** | **5/7** | **6/7** | **7/7** |

^1 False positive -- V3 says "Compaction is no longer a Step 1 action." The grep catches proximity but not negation.
2 V3 adds explicit Trigger B ordering per amended policy.
...
| # | Criterion | Status |
|---|---|---|
| 1 | `new-session.md` is the V3 prompt (canonical, no version suffix) | [x] |
| 2 | v1 superseded, v2 deleted | [x] |
| 3 | Eval findings recorded in this handover | [x] |
| 4 | Clean commit attribution -- one commit per session | [x] |
