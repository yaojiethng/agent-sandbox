...
|---|---|---|
| `docs/operations/handover_policy.md` | Added pre-close propagation replay gate (Step 7b subsection) | [x] Complete |
| `AGENTS.md` (Pi) | Added Propagation Discipline section | [x] Complete |
| `.pi/prompts/session.md` | New prompt template -- `/session` | [x] Complete |
| `.pi/prompts/wrapup.md` | New prompt template -- `/wrapup` | [x] Complete |
| `.pi/prompts/defer.md` | New prompt template -- `/defer` | [x] Complete |
| `.pi/prompts/propagation-check.md` | New prompt template -- `/propagation-check` | [x] Complete |
