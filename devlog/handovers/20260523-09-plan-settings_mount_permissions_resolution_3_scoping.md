...
| `docs/devlog/discussions/story_linux_filesystem_uid_mismatch.md` | Story document -- updated with Strategy 4, setgid correction | [x] Updated |
...
| `docs/devlog/roadmap.md` | Added Track C under M2.7 | [x] Updated |
