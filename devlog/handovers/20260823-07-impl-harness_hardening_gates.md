...
| AC6 | Dead-flag rule in conventions; AGENT_FEEDBACK rot entry mitigated | `bash-coding-conventions.md` §3.3; feedback entry state updated | accepted |
| AC7 | Suite green and deterministic | 628 tests / 38 files / 0 failed ×2 runs | accepted |
...
| [`docs/development/bash-coding-conventions.md`](../../docs/development/bash-coding-conventions.md) | §3.3 no-speculative-flags rule |
