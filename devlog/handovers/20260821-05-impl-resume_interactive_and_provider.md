...
| 5 | `PROVIDER=<n>` no matching records -> clear error | [x] test |
| 6 | bare/unknown still route to help; `--session-id` still silent direct resume | [x] 6 prior shape tests retained |
| 7 | tests updated for new behavior; suite green | [x] 468/468 (3 new tests) |
| 8 | docs + Makefile help reflect implemented picker/filter; roadmap L152 closed | [x] |
