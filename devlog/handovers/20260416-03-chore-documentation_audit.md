...
| File | Change |
|------|--------|
| `docs/devlog/roadmap.md` | Fixed M2.3 status: summary table changed from "Complete" to "In progress"; detail section now shows change status table ([x] Change 4, pending Changes 1-3); Change 4 implementation details added from impl-snapshot-baseline handover |
...
Before starting, read that handover for Change 4 completion context, then read [`20260412-02-m2_3_onhold.md`](20260412-02-m2_3_onhold.md) for the frozen design of Changes 1-3 and [`docs/devlog/discussions/design_git_workflow_improvements.md`](../discussions/design_git_workflow_improvements.md) for the current spec.
