...
- AC1 [x] `run_tests.sh:36` now references `$TEST_DIR` (was undefined
...
- AC2 [x] Code truth pinned (`routing.sh export_path` + `diff_export.sh`):
...
- AC3 [x] Both AF entries (`fixture lifecycle`, `dual-use guards`) escalated
