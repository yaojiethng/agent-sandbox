...
- [`story_prompt_evals.md`](docs/discussions/story_prompt_evals.md) -- How do we test that skills and prompt templates correctly reflect the policy documents they encode? Manual read-through comparison doesn't scale across N skills x M policy sections.
| **Standalone** | |
...
### Phase 1.5 -- Volume-based Session Persistence
