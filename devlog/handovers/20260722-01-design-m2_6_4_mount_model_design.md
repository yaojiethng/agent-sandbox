...
|---|---|---|---|
| 1 | PROJECT_DIR mount wiring traced through Makefile, compose template, start_agent.sh, config | `devlog/discussions/20260722-study-settled-mount_wiring_survey.md` F1, F2 | [x] Agent |
| 2 | Cross-platform path concerns documented | Survey F5b, Open Questions section | [x] Agent |
| 3 | Documentation gaps identified (stale/contradictory/undocumented) | Survey F4 (6 items), F5 (4 items), F6 | [x] Agent |
