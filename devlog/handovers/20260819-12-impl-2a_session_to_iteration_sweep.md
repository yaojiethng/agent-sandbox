...
| `src/reasoning/agent/prompts/whats-next.md` | fresh-session->fresh-iteration, next-session->next-iteration (x2); kept `Mid-session findings\|Findings` 2B dual-grep |
...
| `src/reasoning/agent/drafts/handover-audit.skill.md` | session->iteration (x4); kept `session 20260522-03` C3 date ref |
| `src/reasoning/agent/drafts/roadmap-management.skill.md` | session->iteration (x3) |
...
| `docs/concepts/autonomous_task.md` | session->iteration (x3) |
...
| `docs/development/contributors.md` | session-workflow->iteration-workflow (x2) |
