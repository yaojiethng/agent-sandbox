...
| # | Criterion | Status |
|---|---|---|
| 1 | Phase 3 checks: capability marker file read on host, liveness.txt read on host, brief.md present on host | [x] |
| 2 | Temp files cleaned up after verification | [x] |
| 3 | `SANDBOX_DIR` passed as third arg to `compose_dry_run` | [x] |
| 4 | `bash -n` passes on all modified files | [x] |
| 5 | `make test` passes clean | [x] |
...
| `docs/devlog/roadmap.md` | Marked 11e as [x] |
