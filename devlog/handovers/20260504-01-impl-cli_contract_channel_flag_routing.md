...
- `providers/*/provider.Dockerfile` -- add `COPY routing.sh /opt/sandbox/lib/routing.sh` (x4)
...
| `providers/*/provider.Dockerfile` | Added `COPY routing.sh /opt/sandbox/lib/routing.sh` (x4) |
