...
**Type:** Chore (documentation cleanup)
**Status:** Complete
...
|---|---|---|
| `docs/devlog/handovers/20260412-02-m2_3_onhold.md` | Superseded frozen handover | [x] Deleted |
| `docs/devlog/discussions/design_git_workflow_improvements.md` | Superseded design reference | [x] Deleted |
| `docs/devlog/discussions/design_apply_workflow_and_baseline_advancement.md` | Active design reference; References table updated | [x] Updated |
