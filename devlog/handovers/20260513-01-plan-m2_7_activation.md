...
| # | Criterion | Status |
|---|---|---|
| 1 | M2.5 summary row: `In progress` -> `Deferred -- see M2.5 section` | [x] |
| 2 | M2.5 section body: `Status: Deferred`, tasks shelved | [x] |
| 3 | M2.7 summary row added as `Active` | [x] |
| 4 | M2.7 section body: `Status: Active` | [x] |
| 5 | Settings.json ownership collision fix (item 8) added under M2.7 scope | [x] |
| 6 | Open questions section added to recovery_protocol.md with both items | [x] |
| 7 | `package-branch.md` Makefile reference verified (target exists -- prior finding was incorrect) | [x] |
| 8 | Planning handover created | [x] |
