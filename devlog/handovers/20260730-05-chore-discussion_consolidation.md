...
**Preserved content:** Two-axis model (delivery x backing), 6 decisions, support statuses, 7 open questions, worktree backing deferred decision, superseded documents list.
