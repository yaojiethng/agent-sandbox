...
| # | Criterion | Result |
|---|---|---|
| 1 | All `docs/discussions/` references in current policy docs and project_index.md corrected to `devlog/discussions/` | [x] CLEAN -- `grep -rn "docs/discussions" docs/operations/ docs/development/` returns zero |
| 2 | All `docs/discussions/` link targets and display text in `devlog/roadmap.md` corrected to `./discussions/` or `devlog/discussions/` | [x] CLEAN -- grep returns zero |
| 3 | All `docs/devlog/` references in live (non-superseded) discussion docs, `roadmap_future.md`, AGENTS.md, agent prompts/skills, workflow docs, and compose files corrected | [x] CLEAN -- grep returns zero |
| 4 | Superseded discussion docs left untouched | [x] Confirmed -- 3 superseded docs (`story_obsidian_vault_onboarding`, `20260416-study-superseded-git_worktrees`, `story_linux_filesystem_uid_mismatch`, `20260423-design-active-session_identity_hash_based`, `20260523-design-active-container_layer_redesign`) left with intentional historical refs |
