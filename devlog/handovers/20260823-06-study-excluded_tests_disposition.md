...
| `diagnose_*.sh` x4 | Not executed (container-oriented diagnostics) | Correct category per policy | **Kept** |
...
Suite: 587 -> **620 tests / 37 files, 0 failed, 0 skipped, deterministic x2**.
