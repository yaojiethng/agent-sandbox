...
- [x] Shellcheck backlog: `package_branch.sh` SC2086 (array-ized `GIT_DIFF_OPTS`) + SC1003 (sed->awk blank append) fixed; test-file SC2188 (`: >`) x3, SC2181 (`if`), SC1003 (awk) fixed; SC2034/SC2015/SC2126/SC1090 documented as deliberate/skipped.
