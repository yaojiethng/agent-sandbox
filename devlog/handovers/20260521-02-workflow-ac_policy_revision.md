...
| # | Criterion | Status |
|---|---|---|
| 1 | `docs/operations/handover_policy.md` AC template describes delta model with bugfix/feature/rename guidelines + Step 5 includes precondition rule and validation tool blind spot note | [x] |
| 2 | `docs/operations/iteration_policy.md` AC principle shortened to "describe a delta" | [x] |
| 3 | `docs/development/testing_policy.md` Knowledge Tests section expanded to 3 documented categories with distinct AC rules | [x] |
